inherited frmDosis: TfrmDosis
  ...
  object qPetrobox: TAstaClientDataSet
    ...
    SQL.Strings = (
      'SELECT CODIGOALFANUMERICO as ID, DESCRIPCION,INICIORANGO,'
      
        '    FINRANGO, ULTIMONUMERO, IDESTACION, FECHA_AUTORIZACION, LLAV' +
        'EAUTORIZACIONFISCAL, VALIDO_DESDE, 0 as tipo_id'
      'FROM DOSIFICACIONES')
    Params = <>
    Left = 315
    Top = 5
